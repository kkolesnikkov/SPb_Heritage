...
Ссылка на карту: [SPb_Heritage_MAP_by_function](https://www.google.com/maps/d/u/0/edit?mid=1GueVy33Vnz0hxHJHF3gpEgh_7diRfA8&usp=sharing)
...
![Сводная таблица: функция и период появления](https://github.com/kkolesnikkov/SPb_Heritage/blob/79e1f813d094becdcd96306dda424c049898c507/visualizations/4_%D0%A1%D0%A2.png)  
...
> 2. Вторая интерактивная карта, показывает сосредоточения объектов одной категории. Например, Очень четко прослеживается разница между особняками и дачами: особняки - находятся в центре города, а дач в центре нет, и они располагаются на периферии города. Выделяются сосредоточения заводов - вдоль Московского проспекта, вдоль Лиговского проспекта и в юго-западной части города. Ограды, ворота, бюсты, фонтаны и статую состредотачиваюся в культурных пригородах (Петергоф, Пушкин, ...) помимо центра города.
> 3. По первой сводной таблице видно, что наибоее частотная категория - это жилые дома построенные в 1 пол. 19 века (168), а также жилые дома 1 пол. 20 века (119), 1 пол. 19 века (140) и сады 1 пол. 20 века (122)
> 4. Вторая же демонстрирует связь района и функции. Превалирующая категория (_на удивление_) - могилы в Центральном районе (173) и могилы в дргуих районах: во Фрунзенском (164) и в Василеостровском (143).
> 5. Можно обратить внимание, что в каждом из районов есть могилы и церкви, а статуи и доходные дома только в ограниченном ряде районов.
